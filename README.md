...
This repository is deprecated and no longer maintained as of v1.2.6. Its functionality is maintained in the Python version [SigProfilerExtractor](https://github.com/SigProfilerSuite/SigProfilerExtractor).
<hr>
<br>
